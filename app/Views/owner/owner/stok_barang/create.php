...
<div class="mb-6">
    ...
    <nav class="text-sm text-gray-500 mt-2 breadcrumb-border">
        <span>Dashboard</span> > <span>Barang</span> > <span>Tambah Barang</span>
    </nav>
</div>
<!-- line -->
...
<!-- form -->
<form action="<?= base_url('owner/stok-barang/store') ?>" method="post" class="space-y-8 max-w-full sm:max-w-full bg-white p-8 rounded-lg border border-gray-200 shadow-md">
    <?= csrf_field() ?>
    <div class="">
    ...
    <div class="flex gap-6">
        <!-- submit -->
        <button type="submit" class="flex-1 w-full sm:w-auto inline-flex items-center justify-center px-20 py-3 bg-blue-600 text-white rounded-lg shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-4 focus:ring-blue-400 transition"> <span>+</span> Tambah Barang
        </button>
        <!-- reset -->
        <button type="reset" class="flex-1 w-full sm:w-auto inline-flex items-center justify-center px-20 py-3 text-black border border-gray-300 rounded-lg shadow-sm hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-blue-400 transition">
