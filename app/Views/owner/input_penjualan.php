...
<div class="flex justify-end mb-4">
    <form method="GET" class="relative">
        <input 
            ...
            value="<?= esc($keyword) ?>"
            class="border rounded-lg px-4 py-2 w-64 shadow-sm focus:outline-none focus:ring focus:ring-gray-300"
        >
...
<div class="mt-8">
    ...
    <div class="mt-3 w-full h-40 border rounded-md bg-white shadow-sm"></div>
</div>
