  ...
  <div x-data="{ open: true }" class="">
    <button @click="open = !open" class="flex justify-between w-full py-2 items-center mb-1">
      <div class="flex items-center gap-4">
        ...
        <span class="text-black font-medium">Kelola Cabang</span>
      </div>
  ...
  <div x-data="{ open: true }" class="">
    <button @click="open = !open" class="flex justify-between w-full py-2 items-center mb-1">
      <div class="flex items-center gap-4">
        ...
        <span class="text-black font-medium">Kelola User</span>
      </div>
  ...
  <div x-data="{ open: true }" class="">
    <button @click="open = !open" class="flex justify-between w-full py-2 items-center mb-1">
      <div class="flex items-center gap-4">
        ...
        <span class="text-black font-medium">Laporan Global</span>
      </div>
  ...
  <div x-data="{ open: true }" class="">
    <button @click="open = !open" class="flex justify-between w-full py-2 items-center mb-1">
      <div class="flex items-center gap-4">
        ...
        <span class="text-black font-medium">Keuangan</span>
      </div>
  ...
  <div x-data="{ open: true }" class="">
    <button @click="open = !open" class="flex justify-between w-full py-2 items-center mb-1">
      <div class="flex items-center gap-4">
        ...
        <span class="text-black font-medium">Kategori Barang</span>
      </div>
