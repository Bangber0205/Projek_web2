...
<div class="mb-6">
    <h1 class="text-3xl font-bold text-gray-900">Tambah Cabang Baru</h1>
    <nav class="text-sm text-gray-500 mt-2">
        <span>Dashboard</span> > <span>Tambah Cabang</span>
    </nav>
</div>
...
<div class="bg-white shadow-sm p-6 mb-6">
    ...
    <p class="text-sm text-gray-600 mb-4">Masukkan detail informasi cabang baru</p>
    ...
    <form action="<?= base_url('superadmin/branches/store') ?>" method="POST">
        <?= csrf_field() ?>

        <!-- Nama Cabang -->
        <div class="mb-4">
            <label class="block mb-2 font-medium text-gray-700">Nama Cabang <span class="text-red-500">*</span></label>
            <input type="text" name="name" value="<?= old('name') ?>" placeholder="Masukkan nama cabang" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="location" value="<?= old('location') ?>" placeholder="Masukkan alamat cabang" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
        ...
        <div class="mb-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="relative">
                    ...
                    <input type="email" name="email" value="<?= old('email') ?>" placeholder="Email cabang" class="w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                </div>
            </div>
        </div>
        ...
        <div class="mb-6">
            ...
            <div class="relative">
                <input type="date" name="opening_date" value="<?= old('opening_date') ?>" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500" required>
        ...
        <div class="flex flex-col sm:flex-row gap-4">
            <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg flex items-center justify-center">
                <span class="mr-2">+</span> Tambah Cabang
            </button>
